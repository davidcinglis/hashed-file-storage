 ...
 * a bucket page within a hash file.  Hash files use a slotted-page structure
...
public class BucketPage {
    ...
    private static Logger logger = Logger.getLogger(BucketPage.class);

    /**
     * The offset in the data page where the page number of the
     * next bucket is stored. If there is no next bucket, the page
     * number is 0.
     */

    public static final int OFFSET_NEXT_BUCKET = 0;
    ...
    public static int getNextBucket(DBPage dbPage) { return dbPage.readInt(OFFSET_NEXT_BUCKET); }

    public static void setNextBucket(DBPage dbPage, int pageNum) {dbPage.writeInt(OFFSET_NEXT_BUCKET, pageNum); }
    /**
